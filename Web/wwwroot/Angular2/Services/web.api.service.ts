...
export class WebApiService {
    private webApiUrl: string = 'http://localhost:53531/api/Test/ModifyTest';
    private serviceUrl: string = 'http://localhost:53531/api/Travel/GetService';
    ...
    getService<T>(serviceName: string): Observable<T>
    {
        ...
        return this.http.get(url)
            ...
            //.do(data => console.log('Data loaded: ' + JSON.stringify(data)))
